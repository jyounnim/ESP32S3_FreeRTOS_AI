/*
 * font8x8_basic.h - basic Latin (U+0000-U+007F) 8x8 font, transposed for
 * SSD1306 page-addressing mode (each byte is one 8-pixel-tall column).
 *
 * Source: https://github.com/nopnop2002/esp-idf-ssd1306 (MIT License),
 * itself a transposed version of https://github.com/dhepper/font8x8
 * (public domain, original author Marcel Sondaar / IBM CGA font).
 */
#pragma once
...
static const uint8_t font8x8_basic_tr[128][8] = {
    ...
    { 0x00, 0x04, 0x02, 0xFF, 0x02, 0x04, 0x00, 0x00 },   // U+0001
    { 0x00, 0x20, 0x40, 0xFF, 0x40, 0x20, 0x00, 0x00 },   // U+0002
